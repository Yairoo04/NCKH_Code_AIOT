...
class Config:
    def __init__(self):
        ...
        self.model_path = os.environ.get('MODEL_PATH', os.path.join(base_model_dir, "aggregated_model.pt"))
        self.scaler_path = os.environ.get('SCALER_PATH', os.path.join(base_model_dir, "scaler_server.pkl"))
        self.encoder_path = os.environ.get('ENCODER_PATH', os.path.join(base_model_dir, "label_encoder_server.pkl"))
